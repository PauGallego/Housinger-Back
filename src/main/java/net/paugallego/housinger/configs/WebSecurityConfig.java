        ...
        http.
            ...
            .and()
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET,"/v1/review/**").permitAll()
                    .antMatchers("/v1/review/**").hasAnyRole("P","A","U")
                    .antMatchers("/v1/premium/**").hasAnyRole("P","A","U")
                    .antMatchers("/v1/recover/**").permitAll()
                    .antMatchers(HttpMethod.GET,"/v1/propertyUser/**").permitAll()
                    .antMatchers(HttpMethod.GET,"/v1/reservation/**").permitAll()
                    .antMatchers("/v1/propertyUser/**").hasAnyRole("P","A","U")
                    .antMatchers("/v1/reservation/**").hasAnyRole("P","A","U")
                    .antMatchers(HttpMethod.GET,"/v1/propertyCalendar").permitAll()
                    .antMatchers("/v1/propertyCalendar").hasAnyRole("P","A","U")
                    .antMatchers("/ws/**").permitAll()
                    .antMatchers("/v1/fileCustomer/upload/**").permitAll()
                    .antMatchers(HttpMethod.GET,"/v1/propertyCharacteristics/**").permitAll()
                    .antMatchers(HttpMethod.GET,"/v1/propertyLocation/**").permitAll()
                    .antMatchers(HttpMethod.GET,"/v1/propertyCalendar/**").permitAll()
                    .antMatchers("/v1/propertyCharacteristics/**").hasAnyRole("P","A","U")
                    .antMatchers("/v1/propertyLocation/**").hasAnyRole("P","A","U")
                    .antMatchers("/v1/propertyCalendar/**").hasAnyRole("P","A","U")
                    .antMatchers("/v1/chat/**").hasAnyRole("P","A","U")
                    .antMatchers(HttpMethod.POST, "/v1/fileCustomer/**").permitAll()
                    .antMatchers(HttpMethod.POST, "/v1/propertyCharacteristics/**").hasAnyRole("P","A","U")
                    .antMatchers(HttpMethod.POST, "/v1/propertyCalendar/**").hasAnyRole("P","A","U")
                    .antMatchers(HttpMethod.POST, "/v1/propertyLocation/**").hasAnyRole("P","A","U")
                    .antMatchers(HttpMethod.GET, "/v1/user", "/v1/user/**").hasAnyRole("A", "U")
                    .antMatchers(HttpMethod.POST,  "/v1/user", "/v1/user/**").hasAnyRole("A", "U")
